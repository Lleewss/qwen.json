...
# (no custom nodes were listed in the workflow)
...
RUN comfy model download --url https://civarchive.com/models/2022854?modelVersionId=2289403 --relative-path models/loras --filename Qwen-Image_SmartphoneSnapshotPhotoReality_v4_by-AI_Characters_TRIGGER$amateur photo$.safetensors
